...
Aquifer revision 1.34 - Added mapping of 662 a, b, c, d, f, g, and h and 752 f, g, and h, 2008/05/12 tmee/dlf & laker
Aquifer revision 1.33 - Changed punctuation stripping for 260 2008/04/08 tmee/dlf
Aquifer revision 1.32 - Added mapping of 581 to <note displayLabel="publications"> 2008/03/17 tmee/dlf
Aquifer revision 1.31 - Added mapping of 561 to <note displayLabel="ownership"> 2008/03/17 tmee/dlf
Aquifer revision 1.30 - Added mapping of 510 <note type="citation/reference"> if item is a non-serial 2008/03/17 tmee/dlf
Aquifer revision 1.29 - Deleted mapping of smd=remote 2008/03/10 tmee/dlf
Aquifer revision 1.28 - Changed questionable date mapping 2007/10/23 tmee/dlf
Aquifer revision 1.27 - Added mapping of 242 second indicator (for nonfiling characters) to <titleInfo><nonSort > subelement  2007/08/08  tmee/dlf
Aquifer revision 1.26 - Added mapping of 300 subfield f  2007/08/08  tmee/dlf
Aquifer revision 1.25 - Changed mapping of 767 so that <type="otherVersion>  2007/05/21  tmee/dlf
Aquifer revision 1.24 - Changed mapping of 765 so that <type="otherVersion>  2007/05/21  tmee/dlf
Aquifer revision 1.23 - Changed mapping of 762 from <relatedItem type="series"> to <relatedItem type="constituent">2007/05/21  tmee/dlf
Aquifer revision 1.22 - Added mapping of 655 second indicator code to <genre authority=" "> attribute   2007/05/21  tmee/dlf
Aquifer revision 1.21 - Changed mapping of 538 from <note type="system details"> to <note displayLabel="system details">  2007/06/04  tmee/dlf
Aquifer revision 1.20 - Changed mapping of 533 from <note type="reproduction"> to <note displayLabel="reproduction">2007/05/21  tmee/dlf
Aquifer revision 1.19 - Changed mapping of 511 from <note type="venue"> to <note displayLabel="venue">  2007/06/04  tmee/dlf
Aquifer revision 1.18 - Changed mapping of 511 from <note type="performers"> to <note displayLabel="performers">  2007/06/04  tmee/dlf
Aquifer revision 1.17 - Changed mapping of 506 from <note type="restrictions"> to <accessCondition type="restrictionsOnAccess">  2007/06/04  tmee/dlf
Aquifer revision 1.16 - Added mapping of 250 subfield b 2007/06/04  tmee/dlf
Aquifer revision 1.15 - Changed mapping of 245c from note="type" to note="displayLabel"  2007/05/21  tmee/dlf
Aquifer revision 1.14 - Added mapping of 240 subfield s (version) 2007/05/21  tmee/dlf
Aquifer revision 1.13 - Added mapping of 210 subfield 2 (source) to @authority  2007/05/21  tmee/dlf
Aquifer revision 1.12 - Added mappig of 024 indicator 1=7 so that contents of subfield 2 map to @type 2007/05/21  tmee/dlf
Aquifer revision 1.11 - Added mapping of 008/07-10 (Date1) to keyDate  2007/04/17  tmee/dlf
Aquifer revision 1.10 - Changed @authority from "marc" to "marcgt" for 007 and 008 codes mapped to a term in <genre>  2007/04/17  tmee/dlf
Aquifer revision 1.9 - Added variable and choice protocol for adding the usage="primary display" attribute to one <location><url> element  mapped from tag 856  laker 
Aquifer revision 1.8 - Deleted mapping of tag 856 with @ind2=2 from mapping for subfields u, 3, 7 and z to <location>, mapping of subfield u to <identifier>, mapping of subfield q to <physicalDescription><internetMediaType> and mapping of subfield q to <relatedItem><internetMediaType>   laker
Aquifer revision 1.7 - Deleted mapping of tag 787 to <relatedItem>   laker
Aquifer revision 1.6 - Deleted mapping of tag 786 to <relatedItem>   laker
Aquifer revision 1.5 - Deleted mapping of tag 777 to <relatedItem>    laker
Aquifer revision 1.4 - Deleted mapping of tag 583 to <note>   laker
Aquifer revision 1.3 - Deleted mapping of tag 534 to <note> and to <relatedItem type="original">  laker
Aquifer revision 1.2 - Deleted mapping of tag 530 to <note>   laker
Aquifer revision 1.1 - Deleted mapping of tag 510 to <note> and to <relatedItem type="isReferencedBy">   laker

REVISIONS made by the Library of Congress
	...
	<xsl:template name="marcRecord">
				...
				<title>
					<xsl:variable name="str">
						<xsl:for-each select="marc:subfield">
							<xsl:if
								test="(contains('adfgklmors',@code) and (not(../marc:subfield[@code='n' or @code='p']) or (following-sibling::marc:subfield[@code='n' or @code='p'])))">
								<xsl:value-of select="text()"/>
								<xsl:text> </xsl:text>
							</xsl:if>
						</xsl:for-each>
		...
		<originInfo>
			...
			<xsl:if
				...
				<xsl:if test="$controlField008-7-10">
					<dateIssued encoding="marc" point="start" keyDate="yes">
						<xsl:value-of select="$controlField008-7-10"/>
					</dateIssued>
				</xsl:if>
			</xsl:if>
			...
			<xsl:if test="$controlField008-6='q'">
				<xsl:if test="$controlField008-7-10">
					<dateIssued encoding="marc" point="start" qualifier="questionable" keyDate="yes">
						<xsl:value-of select="$controlField008-7-10"/>
					</dateIssued>
				</xsl:if>
			</xsl:if>
			...
			<!--AQ1.16 tmee/dlf  -->
			<xsl:for-each select="marc:datafield[@tag=250]/marc:subfield[@code='a' or @code='b']">
				<edition>
					<xsl:value-of select="."/>
				</edition>
			</xsl:for-each>
		...
		<xsl:variable name="physicalDescription">
			...
			<!-- AQ1.8 added exclusion of 856 with second indicator 2 to mapping of subfield q to internetMediaType -->
			<xsl:for-each
				select="marc:datafield[@tag=856][@ind2!=2]/marc:subfield[@code='q'][string-length(.)>1]">
				<internetMediaType>
					<xsl:value-of select="."/>
				</internetMediaType>
			</xsl:for-each>
		...
		<xsl:for-each select="marc:datafield[@tag=245]/marc:subfield[@code='c']">
			<note displayLabel="statement of responsibility">
				<xsl:value-of select="."/>
			</note>
		</xsl:for-each>
		...
		<!-- AQ1.1 & AQ1.30 include 510 if non-serial -->

		<xsl:for-each select="marc:datafield[@tag=510]">
			<!--AQ1.18 tmee/dlf -->
			<xsl:if test="$typeOf008!='SE'">
				<note displayLabel="citation/reference">
					<xsl:call-template name="uri"/>
					<xsl:value-of select="marc:subfield[@code='a']"/>
				</note>
			</xsl:if>
		...
		<xsl:for-each select="marc:datafield[@tag=518]">
			<!--AQ1.19 tmee/dlf-->
			<note displayLabel="venue">
				<xsl:call-template name="uri"/>
				<xsl:value-of select="marc:subfield[@code='a']"/>
			</note>
		</xsl:for-each>

		<!-- AQ1.2 deleted mapping of 518 tag to note -->

		<xsl:for-each select="marc:datafield[@tag=533]">

			<!--AQ1.20 tmee/dlf -->
			<note displayLabel="reproduction">
				<xsl:call-template name="uri"/>
				<xsl:variable name="str">
					<xsl:for-each select="marc:subfield[@code!='6' or @code!='8']">
						<xsl:value-of select="."/>
		...
		<!-- AQ1.3 deleted mapping of 534 tag to note -->
		...
		<xsl:for-each select="marc:datafield[@tag=581]">
			<!--AQ1.32 tmee/dlf-->
			<note displayLabel="publications">
				<xsl:call-template name="uri"/>
				<xsl:value-of select="marc:subfield[@code='a']"/>
			</note>
		</xsl:for-each>

		<!-- AQ1.4 deleted mapping tag 583 to note -->

		<xsl:for-each
			select="marc:datafield[@tag=501 or @tag=502 or @tag=504 or @tag=507 or @tag=508 or  @tag=513 or @tag=514 or @tag=515 or @tag=516 or @tag=522 or @tag=524 or @tag=525 or @tag=526 or @tag=535 or @tag=536 or @tag=540 or @tag=541 or @tag=544 or @tag=545 or @tag=546 or @tag=547 or @tag=550 or @tag=552 or @tag=555 or @tag=556 or @tag=562 or @tag=565 or @tag=567 or @tag=580 or @tag=584 or @tag=585 or @tag=586]">
			<note>
				<xsl:call-template name="uri"/>
				<xsl:variable name="str">
					<xsl:for-each select="marc:subfield[@code!='6' or @code!='8']">
		...
		<!-- AQ1.1, AQ1.3 deleted mapping of tags 510 and 534 to relatedItem -->

		<!--AQ1.20 tmee/dlf -->
		<xsl:for-each select="marc:datafield[@tag=533][marc:subfield[@code='t']]">
			<relatedItem type="series">
				<titleInfo>
					<title>
						<xsl:call-template name="chopPunctuation">
		...
		<!-- AQ1.6 deleted mapping of tag 786 to relatedItem -->
		...
		<!-- AQ1.8 deleted mapping of 856 2nd indicator 2 subfield u mapping to relatedItem internetMediaType -->
		...
		<!-- AQ1.12 tmee/dlf  when ind1=7-->
		<xsl:for-each select="marc:datafield[@tag='024'][@ind1='7']">
			<xsl:call-template name="isInvalid">
				<xsl:with-param name="type">other standard identifier</xsl:with-param>
			</xsl:call-template>
			<identifier>
				<xsl:attribute name="type">
					<xsl:value-of select="marc:subfield[@code='2']"/>
				...
				<xsl:call-template name="subfieldSelect">
					<xsl:with-param name="codes">acdz</xsl:with-param>
					<xsl:with-param name="delimeter">-</xsl:with-param>
				</xsl:call-template>
			</identifier>
		</xsl:for-each>
		...
		<!-- AQ1.8 excluded mapping of 856 with 2nd indicator 2 to identifier -->
		...
		<!-- 1/04 fix added $y -->
		<!-- AQ1.8 excluded mapping 856 with 2nd indicator 2 to location -->
		<xsl:for-each select="marc:datafield[@tag=856][@ind2!=2][marc:subfield[@code='u']]">
			<location>
				<url>
					<!-- AQ1.9 added choice protocol for @usage="primary display" -->
